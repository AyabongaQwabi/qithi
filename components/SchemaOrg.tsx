...
export const amaqithiSchema = {
  ...
  headline: 'AmaQithi Clan — Mqithi History, Qithi Meaning in Xhosa, Iziduko & Clan Names',
  description:
    'AmaQithi clan: San lineage assimilated into Thembu history in the Eastern Cape. Qithi meaning in Xhosa, iziduko (mqithi clan praises), AmaQithi clan names and surnames across eNgcobo, Lady Frere, Cofimvaba and the Free State. The full history of the people marked by the Ingqithi.',
  datePublished: '2025-01-01',
  dateModified: new Date().toISOString().split('T')[0],
  author: { '@id': `${BASE}/#organization` },
  publisher: { '@id': `${BASE}/#organization` },
  inLanguage: 'en-ZA',
  keywords: 'AmaQithi clan, AmaQithi clan names, Mqithi clan, Mqithi clan praises, iziduko mqithi, Qithi meaning in Xhosa, Qithi clan names, Qithi clan praises, Qithi history in South Africa, izibongo AmaQithi, Umqithi, Ndinga, Rhadu, Mnono, Nomsobondwana, Umlebe, Sopitsho, Yem Yem, Ngqolomsila, Vela Bambhentsele, Amantande, Ingqithi',
  about: [
    { '@type': 'Thing', name: 'AmaQithi clan', description: 'San (AbaThwa) lineage assimilated into Thembu history in Lady Frere and wider Eastern Cape memory' },
    { '@type': 'Thing', name: 'Mqithi clan praises', description: 'Iziduko (izibongo) of AmaQithi: Umqithi, Ndinga, Rhadu, Mnono, Nomsobondwana, Umlebe, U Nkomo ayizali izala ngoku miselwa, Sopitsho, Yem Yem, Ngqolomsila, Vela Bambhentsele, Amantande — NgamaQithi amahle neenzipho zawo' },
    { '@type': 'Thing', name: 'Qithi meaning in Xhosa', description: 'From isi-Qiti: a separated, enclosed or isolated space; the Q is a San palatal click consonant marking indigenous First People origin' },
    ...
    { '@type': 'Place', name: 'Quthing, Lesotho', description: 'Frontier district central to San, Phuthi, and Thembu conflict-era history around 1879', geo: { '@type': 'GeoCoordinates', latitude: -30.4060, longitude: 27.7058 } },
    { '@type': 'Place', name: 'Rhodana, Lady Frere', geo: { '@type': 'GeoCoordinates', latitude: -31.7048, longitude: 27.2328 } },
    { '@type': 'Place', name: 'eNgcobo, Eastern Cape', geo: { '@type': 'GeoCoordinates', latitude: -31.6670, longitude: 27.8930 } },
    { '@type': 'Place', name: 'Cofimvaba, Eastern Cape', geo: { '@type': 'GeoCoordinates', latitude: -31.9980, longitude: 27.5940 } },
  ],
  mentions: [
    { '@type': 'Person', name: 'Qwabi Joka', description: 'San patriarch born 1842 in the White Kei basin; died 1915 in Mkapusi, Lady Frere' },
    { '@type': 'Person', name: 'King Moorosi', description: 'BaPhuthi chief at Quthing, Lesotho; 1879 war forced AmaQithi dispersal' },
    { '@type': 'Person', name: 'Ngcongolo', description: 'Named in oral history as the first Qithi person to arrive at the place called Qiti, with his brother Mafilika; son of Tsula' },
    { '@type': 'Person', name: 'Queen Nonesi', description: 'Thembu Queen Regent who established the Great Place at Rhodana in 1841, adjacent to Qithi Village' },
  ],
