...
export const amaqithiSchema = {
  ...
  description:
    'AmaQithi clan: Thembu-San lineage rooted in Quthing, Lesotho. Qithi meaning in Xhosa, iziduko (mqithi clan praises), AmaQithi clan names and surnames across eNgcobo, Lady Frere, Cofimvaba and the Free State. The full history of the people marked by the Ingqithi.',
  datePublished: '2025-01-01',
  dateModified: new Date().toISOString().split('T')[0],
  author: { '@id': `${BASE}/#organization` },
  publisher: { '@id': `${BASE}/#organization` },
  inLanguage: 'en-ZA',
  keywords: 'AmaQithi clan, AmaQithi clan names, Mqithi clan, Mqithi clan praises, iziduko mqithi, Qithi meaning in Xhosa, Qithi clan names, Qithi clan praises, Qithi history in South Africa, Qithi in Lesotho, Qithi in Quthing, izibongo AmaQithi, Qwabi clan, Ingqithi',
  about: [
    { '@type': 'Thing', name: 'AmaQithi clan', description: 'Thembu clan with San (AbaThwa) lineage rooted in Quthing, Lesotho and Lady Frere, Eastern Cape' },
    { '@type': 'Thing', name: 'Mqithi clan praises', description: 'Iziduko (izibongo) of AmaQithi: Ndinga, Rhadu, Mnono, Mlebe, Nomsobodwana, Sopitsho Ngqolomsila, Yemyem — NgamaQithi amahle neenzipho zawo' },
    ...
    { '@type': 'Place', name: 'Quthing, Lesotho', description: 'Sotho pronunciation of emaQithini — the place of the Qithi; San sanctuary under King Moorosi until 1879', geo: { '@type': 'GeoCoordinates', latitude: -30.4060, longitude: 27.7058 } },
